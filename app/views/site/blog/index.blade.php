...
@section('content')
 <div class="pull-right">
                                <a href="{{{ URL::to('maintenances/create') }}}" class="btn btn-small btn-info iframe"><span class="glyphicon glyphicon-plus-sign"></span> Create</a>
                        </div>
...
<div class="row">
	<div class="col-md-8">
		...
		<!--	<div class="col-md-2">
			...
			<div class="col-md-6">
				<p>
                                     Status: {{ $post->meta_keywords }}
                                </p>
				<p>
                                     Unit Name: {{ $post->meta_title }}
                                </p>
				 <p>
                                     Unit Number: {{ $post->meta_description }}
                                </p>
				<p>
